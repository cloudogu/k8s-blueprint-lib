...
func (in *BlueprintSpec) DeepCopyInto(out *BlueprintSpec) {
	*out = *in
	...
	if in.IgnoreComponentHealth != nil {
		in, out := &in.IgnoreComponentHealth, &out.IgnoreComponentHealth
		*out = new(bool)
		**out = **in
	}
...
func (in *StateDiff) DeepCopyInto(out *StateDiff) {
	*out = *in
	...
	if in.DoguConfigDiffs != nil {
		...
		*out = make(map[string]ConfigDiff, len(*in))
		for key, val := range *in {
			var outVal []ConfigEntryDiff
			if val == nil {
				(*out)[key] = nil
			} else {
				inVal := (*in)[key]
